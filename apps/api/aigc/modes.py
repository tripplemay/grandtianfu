...
RENDER_MODES: dict[str, dict] = {
    AXON_PHOTOREAL: {"artifact_kind": "ai-render", "base_kind": "ai-base", "thumb_kind": "ai-thumb"},
    REAL_PHOTO: {"artifact_kind": "real-render", "base_kind": "real-base", "thumb_kind": "real-thumb"},
}
